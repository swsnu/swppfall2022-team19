...
# sudo docker run -d -p 80:80 --rm --name "frontend" frontend:latest

ENCRYPT_SSL_FULLCHAIN_PATH="/etc/letsencrypt/archive/letmecu.site/fullchain1.pem"
ENCRYPT_SSL_PRIVKEY_PATH="/etc/letsencrypt/archive/letmecu.site/privkey1.pem"
